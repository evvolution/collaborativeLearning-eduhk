  ...
  <div class="video-class">
    ...
    <div class="video-pad">
      ...
      <t-form label-align="top" v-if="videoData">
        <t-form-item>
          <template #label>
            <t-tag variant="outline" content="Description" theme="primary" shape="round"/>
          </template>
          {{ videoData.description }}
        </t-form-item >
        <t-form-item>
          <template #label>
            <t-tag variant="outline" content="Attachments" theme="primary" shape="round"/>
          </template>
...
<!-- :poster="pngUrl('defaultvideocover')" -->
...
const getStartTime = () => {
  if (caseVideo.value) {
    ...
    caseVideoTime_s.value = caseVideo.value.duration
  }
}
const getEndTime = () => {
  if (caseVideo.value) {
