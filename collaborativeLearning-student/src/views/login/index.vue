    ...
    <div class="section-right">
      <t-form class="sectionForm" ref="form" :data="loginForm" :colon="true" :label-width="0"  @submit="handleLogin">
        <t-space align="center" class="loginForm">
          <img height="50" src="https://www.eduhk.hk/cms/assets/shared/img/logo_foot.png" alt="logo" />
...
import { DesktopIcon, LockOnIcon, InfoCircleIcon } from 'tdesign-icons-vue-next'
